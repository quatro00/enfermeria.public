export class routes {
  ...
  public static get doctorProfileSettings(): string {
    return this.baseUrl + '/doctors/doctor-profile-settings';
  }
  ...
  public static get scheduleTimings(): string {
    return this.baseUrl + '/doctors/schedule-timings';
  }
  ...
  // User routes ends
  public static get appoinment3(): string {
    return this.baseUrl + '/pharmacy/register/pharmacy-register-step3';
  }
  public static get appoinment4(): string {
    return this.baseUrl + '/pharmacy/register/pharmacy-register-step3';
  }
  public static get appoinment5(): string {
    return this.baseUrl + '/pharmacy/register/pharmacy-register-step3';
  }
  public static get appoinment6(): string {
    return this.baseUrl + '/pharmacy/register/pharmacy-register-step3';
  }
}
